        ...
        <Card>
          <CardContent className="pt-4 pb-3">
            <div className="flex items-center justify-between">
              ...
              <div className="rounded-md bg-muted/50 p-2">
                <IconAlertTriangle size={18} className={data.staleCount > 0 ? 'text-foreground' : 'text-muted-foreground'} />
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                {data.agents.map((agent) => (
                  <tr key={agent.name} className="border-b last:border-0">
                    <td className="py-2 flex items-center gap-2">
                      ...
                      {agent.isStale && (
                        <span className="inline-flex items-center gap-1 rounded bg-muted px-1.5 py-0.5 text-[10px] text-muted-foreground italic">
